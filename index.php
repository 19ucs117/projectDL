      ...
      <ul class="menu">
        <li style="float: left">
          <a href="https://www.loyolacollege.edu/" class="" rel="home" id="header--wordmark">
            <div class="logo" style="height: 50px;overflow: hidden;justify-content: space-around; width: 310px;margin-left: -50px;margin-top: -15px;padding: 0;background-color: #002567">
              <center>
